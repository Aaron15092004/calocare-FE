...
import { Home, BookOpen, Calendar, User, Plus, ScanLine, QrCode, PenLine, BarChart2, MapPin } from "lucide-react";
...
const FAB_ACTIONS = [
    { icon: ScanLine,  label: "AI Scan",  target: "/diary",   angle: 160, iconCls: "text-primary"  },
    { icon: QrCode,    label: "Mã vạch",  target: "barcode",  angle: 125, iconCls: "text-protein"  },
    { icon: PenLine,   label: "Ghi tay",  target: "/diary",   angle: 90,  iconCls: "text-calories" },
    { icon: BarChart2, label: "Báo cáo",  target: "/reports", angle: 55,  iconCls: "text-vitamins" },
    { icon: MapPin,    label: "Gần đây",  target: "/nearby",  angle: 20,  iconCls: "text-fat"      },
];
        ...
        <>
            <div
                className={cn(
                    ...
                    isOpen ? "backdrop-blur-sm bg-black/25 pointer-events-auto" : "pointer-events-none opacity-0"
                )}
                onClick={closeFan}
            />
                    ...
                    <div className="flex-1 flex items-center justify-center">
                        <div className="relative -mt-7 w-16 h-16">
                            ...
                            <button
                                ...
                                className="absolute inset-0 w-16 h-16 rounded-full gradient-primary shadow-ios flex items-center justify-center active:scale-95 transition-transform duration-150"
                                style={{ zIndex: 52 }}
                            >
                                <Plus
                                    className={cn(
